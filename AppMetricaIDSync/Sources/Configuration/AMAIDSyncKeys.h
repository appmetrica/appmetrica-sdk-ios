...
extern NSString *const AMAIDSyncRequestTypeKey;
extern NSString *const AMAIDSyncRequestUrlKey;
extern NSString *const AMAIDSyncRequestHeadersKey;
extern NSString *const AMAIDSyncRequestPreconditionsKey;
...
extern NSString *const AMAIDSyncStorageLaunchDelaySecondsKey;
