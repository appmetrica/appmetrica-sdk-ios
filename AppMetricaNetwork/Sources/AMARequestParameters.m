...
static NSString *const kAMAMainAppIDKey = @"mai";
static NSString *const kAMAExtensionAppIDKey = @"eai";
                       ...
                       options:(AMARequestParametersOptions)options
{
    ...
    if (self != nil) {
        ...
        _appID = [[[AMAPlatformDescription currentAppInfo] appID] copy];
        _mainAppID = [[[AMAPlatformDescription mainAppInfo] appID] copy];
        _extensionAppID = [[[AMAPlatformDescription extensionAppInfo] appID] copy];
...
+ (instancetype)objectWithDictionaryRepresentation:(NSDictionary *)dictionary
{
    ...
    parameters.mainAppID = [dictionary[kAMAMainAppIDKey] copy];
    parameters.extensionAppID = [dictionary[kAMAExtensionAppIDKey] copy];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    parameters[kAMAMainAppIDKey] = self.mainAppID;
    parameters[kAMAExtensionAppIDKey] = self.extensionAppID;
