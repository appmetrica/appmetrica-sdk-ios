...
SPEC_BEGIN(AMAReporterDatabaseMigrationTo500EncodersFactoryTests)

describe(@"AMAReporterDatabaseMigrationTo500EncodersFactory", ^{

    NSData *const iv = [@"500_IV" dataUsingEncoding:NSUTF8StringEncoding];
