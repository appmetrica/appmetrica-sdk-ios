...
describe(@"AMAEventComposer", ^{
    context(@"Compose", ^{
        ...
        id __block errorEnvironmentComposer = nil;
        ...
        NSDictionary *errorEnvironment = @{ @"key3" : @"value3", @"key4" : @"value4" };
        ...
        beforeEach(^{
            ...
            errorEnvironmentComposer = [KWMock nullMockForProtocol:@protocol(AMAErrorEnvironmentComposer)];
            [[errorEnvironmentComposer should] conformToProtocol:@protocol(AMAErrorEnvironmentComposer)];
            ...
            [builder stub:@selector(errorEnvironmentComposer) andReturn:errorEnvironmentComposer];
            ...
            [errorEnvironmentComposer stub:@selector(compose) andReturn:errorEnvironment];
        ...
        it(@"Should use all composers", ^{
            ...
            [[errorEnvironmentComposer should] receive:@selector(compose)];
            ...
            [[event.errorEnvironment should] equal:errorEnvironment];
