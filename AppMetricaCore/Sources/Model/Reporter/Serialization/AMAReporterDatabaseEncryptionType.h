...
typedef NS_ENUM(NSUInteger, AMAReporterDatabaseEncryptionType) {
    ...
    // The key is 8eed7f8d98844045933e986e412ae92b (hex), iv is sha256(bundleID ?: "io.appmetrica.sdk")
    AMAReporterDatabaseEncryptionTypeAES = 0,

    // AES-128 encryption with GZip compression
    // The key is af9dca1be79a4197a04b42242850c6c2 (hex), iv is sha256(bundleID ?: "io.appmetrica.sdk")
