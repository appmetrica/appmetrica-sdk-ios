Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 5.13.0'
  s.dependency 'AppMetricaWebKit', '= 5.13.0'
  s.dependency 'AppMetricaCrashes', '= 5.13.0'
  s.dependency 'AppMetricaScreenshot', '= 5.13.0'
end
