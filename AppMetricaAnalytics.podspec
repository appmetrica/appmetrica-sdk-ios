Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 6.4.1'
  s.dependency 'AppMetricaWebKit', '= 6.4.1'
  s.dependency 'AppMetricaCrashes', '= 6.4.1'
  s.dependency 'AppMetricaScreenshot', '= 6.4.1'
  s.dependency 'AppMetricaIDSync', '= 6.4.1'
