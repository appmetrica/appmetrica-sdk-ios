Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 5.10.1'
  s.dependency 'AppMetricaWebKit', '= 5.10.1'
  s.dependency 'AppMetricaCrashes', '= 5.10.1'
  s.dependency 'AppMetricaScreenshot', '= 5.10.1'
end
