Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 5.11.1'
  s.dependency 'AppMetricaWebKit', '= 5.11.1'
  s.dependency 'AppMetricaCrashes', '= 5.11.1'
  s.dependency 'AppMetricaScreenshot', '= 5.11.1'
end
