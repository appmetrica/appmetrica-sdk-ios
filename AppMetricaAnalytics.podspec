Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 5.16.1'
  s.dependency 'AppMetricaWebKit', '= 5.16.1'
  s.dependency 'AppMetricaCrashes', '= 5.16.1'
  s.dependency 'AppMetricaScreenshot', '= 5.16.1'
  s.dependency 'AppMetricaIDSync', '= 5.16.1'
end
