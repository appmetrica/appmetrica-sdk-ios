Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 5.12.0'
  s.dependency 'AppMetricaWebKit', '= 5.12.0'
  s.dependency 'AppMetricaCrashes', '= 5.12.0'
  s.dependency 'AppMetricaScreenshot', '= 5.12.0'
end
