Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 6.5.1'
  s.dependency 'AppMetricaWebKit', '= 6.5.1'
  s.dependency 'AppMetricaCrashes', '= 6.5.1'
  s.dependency 'AppMetricaScreenshot', '= 6.5.1'
  s.dependency 'AppMetricaIDSync', '= 6.5.1'
