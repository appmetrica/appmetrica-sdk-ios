Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 6.1.0'
  s.dependency 'AppMetricaWebKit', '= 6.1.0'
  s.dependency 'AppMetricaCrashes', '= 6.1.0'
  s.dependency 'AppMetricaScreenshot', '= 6.1.0'
  s.dependency 'AppMetricaIDSync', '= 6.1.0'
end
