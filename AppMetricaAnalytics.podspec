Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaAdSupport', '= 5.17.0'
  s.dependency 'AppMetricaWebKit', '= 5.17.0'
  s.dependency 'AppMetricaCrashes', '= 5.17.0'
  s.dependency 'AppMetricaScreenshot', '= 5.17.0'
  s.dependency 'AppMetricaIDSync', '= 5.17.0'
end
