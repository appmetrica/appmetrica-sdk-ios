...
@class AMAFMDatabase;
@class AMAFMStatement;

/** Types for columns in a result set.
 */
typedef NS_ENUM(int, AMASqliteValueType) {
    AMASqliteValueTypeInteger = 1,
    AMASqliteValueTypeFloat   = 2,
    AMASqliteValueTypeText    = 3,
    AMASqliteValueTypeBlob    = 4,
    AMASqliteValueTypeNull    = 5
};
...
@property (nonatomic, retain, nullable) AMAFMDatabase *parentDB;
...
@property (atomic, retain, nullable) AMAFMStatement *statement;
