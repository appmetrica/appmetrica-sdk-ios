...
NSString *const kAMACrashContextAppVersionKey = @"io.appmetrica.mobile.crash.appVersion";
NSString *const kAMACrashContextAppBuildNumberKey = @"io.appmetrica.mobile.crash.appBuildNumber";
