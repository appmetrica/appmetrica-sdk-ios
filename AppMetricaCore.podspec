Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaNetwork', '= 5.8.1'
  s.dependency 'AppMetricaCoreUtils', '= 5.8.1'
  s.dependency 'AppMetricaHostState', '= 5.8.1'
  s.dependency 'AppMetricaProtobufUtils', '= 5.8.1'
  s.dependency 'AppMetricaPlatform', '= 5.8.1'
  s.dependency 'AppMetricaStorageUtils', '= 5.8.1'
  s.dependency 'AppMetricaEncodingUtils', '= 5.8.1'
  s.dependency 'AppMetricaProtobuf', '= 5.8.1'
  s.dependency 'AppMetricaFMDB', '= 5.8.1'
