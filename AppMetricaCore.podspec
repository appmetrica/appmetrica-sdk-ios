Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaProtobufUtils', '= 5.10.0'
  ...
  s.dependency 'AppMetricaProtobuf', '= 5.10.0'
  s.dependency 'AppMetricaFMDB', '= 5.10.0'
  s.dependency 'AppMetricaKeychain', '= 5.10.0'
  s.dependency 'AppMetricaIdentifiers', '= 5.10.0'
