Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaNetwork', '= 5.14.0'
  s.dependency 'AppMetricaCoreUtils', '= 5.14.0'
  s.dependency 'AppMetricaHostState', '= 5.14.0'
  s.dependency 'AppMetricaProtobufUtils', '= 5.14.0'
  s.dependency 'AppMetricaPlatform', '= 5.14.0'
  s.dependency 'AppMetricaStorageUtils', '= 5.14.0'
  s.dependency 'AppMetricaEncodingUtils', '= 5.14.0'
  s.dependency 'AppMetricaProtobuf', '= 5.14.0'
  s.dependency 'AppMetricaFMDB', '= 5.14.0'
  s.dependency 'AppMetricaKeychain', '= 5.14.0'
  s.dependency 'AppMetricaIdentifiers', '= 5.14.0'
