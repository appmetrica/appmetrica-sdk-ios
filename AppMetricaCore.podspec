Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaNetwork', '= 5.11.1'
  s.dependency 'AppMetricaCoreUtils', '= 5.11.1'
  s.dependency 'AppMetricaHostState', '= 5.11.1'
  s.dependency 'AppMetricaProtobufUtils', '= 5.11.1'
  s.dependency 'AppMetricaPlatform', '= 5.11.1'
  s.dependency 'AppMetricaStorageUtils', '= 5.11.1'
  s.dependency 'AppMetricaEncodingUtils', '= 5.11.1'
  s.dependency 'AppMetricaProtobuf', '= 5.11.1'
  s.dependency 'AppMetricaFMDB', '= 5.11.1'
  s.dependency 'AppMetricaKeychain', '= 5.11.1'
  s.dependency 'AppMetricaIdentifiers', '= 5.11.1'
