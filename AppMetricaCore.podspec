Pod::Spec.new do |s|
  ...
  s.dependency 'AppMetricaLog', '= 5.6.0'
  s.dependency 'AppMetricaNetwork', '= 5.6.0'
  s.dependency 'AppMetricaCoreUtils', '= 5.6.0'
  s.dependency 'AppMetricaHostState', '= 5.6.0'
  s.dependency 'AppMetricaProtobufUtils', '= 5.6.0'
  s.dependency 'AppMetricaPlatform', '= 5.6.0'
  s.dependency 'AppMetricaStorageUtils', '= 5.6.0'
  s.dependency 'AppMetricaEncodingUtils', '= 5.6.0'
  s.dependency 'AppMetricaProtobuf', '= 5.6.0'
  s.dependency 'AppMetricaFMDB', '= 5.6.0'
