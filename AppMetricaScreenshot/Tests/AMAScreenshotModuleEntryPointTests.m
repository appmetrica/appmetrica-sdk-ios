...
@property (nonatomic, strong) AMAScreenshotModuleEntryPoint *entryPoint;
@end
...
- (void)setUp
{
    ...
    self.entryPoint = [AMAScreenshotModuleEntryPoint new];
...
- (void)testModuleName
{
    XCTAssertEqualObjects(self.entryPoint.moduleName, @"AppMetricaScreenshot");
}
