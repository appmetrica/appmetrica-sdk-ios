...
struct FlowStartEventAssembler: ProductFlowEventAssembling {
    ...
    func assemble(builder: FlowStartEventBuilder) -> AssemblyResult {
        ...
        let productIdResult = stringConverter.convert(builder.productId.rawValue)
        proto.productID = productIdResult.value
        bytesTruncated += productIdResult.bytesTruncated
